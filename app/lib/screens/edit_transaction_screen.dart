...
class _EditTransactionScreenState extends State<EditTransactionScreen> {
  ...
  Future<MyLabel?> _showLabelPicker() {
    return showDialog<MyLabel>(
      context: context,
      builder: (context) {
        return SimpleDialog(
  ...
  List<Widget> _getLabelChooserList(List<MyLabel> labelsList) {
  ...
  void initState() {
    ...
    if (widget.editTransactionId != null) {
      ...
      id = _editableTransaction.labelId;
    } else {
      id = "";
    }
    _selectedLabel = _labelsData.findById(id);
  ...
  String get submitButtonText {
    ...
    final incomeOrExpense = (_selectedLabel!.labelType == LabelType.INCOME) ? 'INCOME' : 'EXPENSE';
        ...
        child: Column(
          children: <Widget>[
            EditTransactionAppbar(
              containerColor: Theme.of(context).colorScheme.largeTypeColor(labelType: _selectedLabel!.labelType),
                ...
                children: <Widget>[
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      ...
                      // amount inputs.
                      if (_selectedLabel!.labelType == LabelType.INCOME && amountVal < 0) {
                        return 'Please enter a positive number';
                      }
                      if (double.parse(amountVal.toStringAsFixed(2)) != amountVal) {
                    ...
                    onSaved: (newValue) {
                      ...
                      if (_selectedLabel!.labelType == LabelType.INCOME) {
                        _editableTransaction.amount = double.parse(newValue!).abs();
                      } else {
                        _editableTransaction.amount = -double.parse(newValue!).abs();
                      }
                    },
